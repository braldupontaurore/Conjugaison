...
const URLSuite = "&tense="; // ne pas préciser le temps sinon il n'est pas possible de le modifier dans la requête.
...
const Verbe = () => {
  ...
  const searchVerbe = async () => {
    const response = await axios.get(URLVerbe + verbes + URLSuite + temps)
